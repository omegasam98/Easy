...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String ema = mMyAppsBundlecon.getString("mail");
    private String nam = mMyAppsBundlecon.getString("dame");
    private String con = mMyAppsBundlecon.getString("mon");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), Forgotpass.class);
                startActivity(i);
                //Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                       // .setAction("Adding reservation", fab);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            startActivity(new Intent(MainActivity.this, ban.class));
